...
| [aws_lakeformation_permissions.share_data_location_dbt_access](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lakeformation_permissions) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_data_platform_account_id"></a> [data\_platform\_account\_id](#input\_data\_platform\_account\_id) | AWS Account ID of the Data Platform account | `string` | n/a | yes |
| <a name="input_data_platform_governance_account_id"></a> [data\_platform\_governance\_account\_id](#input\_data\_platform\_governance\_account\_id) | AWS Account ID of the Data Platform Governance account | `string` | n/a | yes |
| <a name="input_dbt_access_trusted_role_arn"></a> [dbt\_access\_trusted\_role\_arn](#input\_dbt\_access\_trusted\_role\_arn) | IAM role ARN allowed to assume the dbt-access role | `string` | n/a | yes |
